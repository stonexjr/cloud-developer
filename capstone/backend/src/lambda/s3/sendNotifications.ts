...
const logger = createLogger('sendNotifications.ts');
...
/*
{
    "Records": [
    {
        ...
        "userIdentity": {
            "principalId": "AWS:AROA3XHH3JEXNWO6RX7HX:serverless-txn-app-dev-CreateTxn"
        },
        "requestParameters": {
        ...
        "s3": {
            "s3SchemaVersion": "1.0",
            "configurationId": "serverless-txn-app-dev-SendUploadNotifications-68a737133cefb25bff959852b8f04754",
            "bucket": {
                "name": "serverless-txn-image-dev",
                "ownerIdentity": {
                    "principalId": "A4Z7F3PO6C8P7"
                },
                "arn": "arn:aws:s3:::serverless-txn-image-dev"
            },
            "object": {
